...
I tested each of the three programs across these nine samples on default settings, 
enabling or disabling the collapse of overlapping read pairs, respectively. I summarised the 
performance of the adapter removal using FastQC [@Andrews2010] and summarised all reports into 
summary tables using MultiQC [@Ewels2016].
...
ith either medium or short read length distribution.
